---
description: Remove a change worktree via openspec-ops finish (keeps branch; not archive)
---
...
**Input:** change name (kebab-case) after `/ops-finish`. Optional user intent for `--force` if dirty.
**Provided arguments:** $@
