---
description: Locate the worktree path for an OpenSpec change (openspec-ops where)
---
...
**Input:** change name (kebab-case) after `/ops-where`.
**Provided arguments:** $@
...
3. Outcomes:
   ...
   | exit 5 `not_found` | Say not found; suggest `/ops-start` |
