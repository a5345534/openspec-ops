# lifecycle-phase-gates Specification

## Purpose

Phase-aware ops-spec-review refusal for archived/split-brain changes and doctor detection of active-vs-archived location mismatch.
