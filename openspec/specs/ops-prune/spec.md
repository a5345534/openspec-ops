# ops-prune Specification

## Purpose

Safe deletion of local and remote change branches only when a pull request for that head branch is merged and no openspec-ops worktree remains for the change.
