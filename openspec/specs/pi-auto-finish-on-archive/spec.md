...
Pi harness gate that watches for inactive (typically archived) OpenSpec changes and reclaims orphan openspec-ops worktrees via CLI finish, without modifying OpenSpec archive.
